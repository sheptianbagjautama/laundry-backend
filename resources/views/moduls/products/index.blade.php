                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-bordered" id="dynamicTable">
                                    ...
                                    <tr class="tr-body-0 table-group-product">
                                        <td style="width: 30%">
                                            <select class="form-control select2 select-groups-0" style="width: 100%;"
    ...
    <script type="text/javascript">
        ...
        $("#add").click(function() {
            ...
            $("#dynamicTable").append(`<tr class="tr-body-${i} table-group-product">
                                        <td style="width: 30%">
                                            <select  class="form-control select2 select-groups-${i}" style="width: 100%;"
        ...
        $(function() {
            ...
            $('#productForm').validate({
                ...
                messages: {
                    ...
                    type_id: {
                        required: "Silahkan masukan tipe barang",
                    },
                },
                errorElement: 'span',
